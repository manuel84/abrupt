...
Das größte Element ist also direkt ablesbar, weil ein anderes größeres (abgeleitetes) Element dieses übersteigen könnte. 
...
Gegenüber konventionellen Programmierparadigmen
alter Converter:
