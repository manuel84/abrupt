...
Dazu gehören das Schriftbild, die Farben, Logos, und vieles mehr.
Des Weiteren wurden jede Menge Web-Dienste entwickelt, die den Webseiten mehr Interaktivität einräumen. 
Viele Webanwendungen ähneln komplexer Software, die eine grafische Benutzeroberfläche mit Drag \& Drop im Browser zur Verfügung stellen.
