...
Anfangs boten nur eine kleine Anzahl von Institutionen, Firmen, Regierungen spärliche, textuelle Informationen an. 
Mittlerweile gehört die Webseite zum Aushängeschild eines Unternehmens. 
Das Aussehen muss dabei häufig zur Unternehmensphilosphie passen, das sogenannte Cooperate Desogn sorgt für eine visuelle Identität, um sich von anderen Unternehmen zu unterschieden. 
\newpage
